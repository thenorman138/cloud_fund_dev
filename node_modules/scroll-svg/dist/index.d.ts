...
type Options = Required<OptionalOptions>;
interface ScrollSvgClass {
    /**
 ...
 */
declare class scrollSvgClass implements ScrollSvgClass {
    svgPath: SVGPathElement;
    options: Options;
    animationFrame: number;
    prevBoundingRectTop: number;
    ...
    changeOptions(userOptions: OptionalOptions): boolean;
    changeSvgPath(newSvgPath: SVGPathElement): boolean;
    getOptions(): Required<OptionalOptions>;
    getSvgPath(): SVGPathElement;
    getPercentageDrawn(): number;
    clear(): void;
    fill(): void;
 ...
 */
declare class scrollSvgEmptyClass implements ScrollSvgClass {
    svgPath: SVGPathElement;
    options: Options;
    animationFrame: number;
    prevBoundingRectTop: number;
 ...
 */
declare function scrollSvg(svgPath: SVGPathElement, userOptions?: OptionalOptions): scrollSvgEmptyClass | scrollSvgClass;
/**
 * Returns either `ScrollSvgClass` used to control how and when the svg is drawn
 ...
 * @param {OptionalOptions} userOptions Options to customize how and when the SVG is drawn
 */
declare function scrollSvgNullable(svgPath: SVGPathElement, userOptions?: OptionalOptions): scrollSvgClass | null;

export { scrollSvg as default, scrollSvgNullable };
